...
String processor(const String& var){
  ...
  else if(var == "temperaturaSensor"){
    return String(temperaturaSensor);
  }
  else if(var == "temperaturaDesejada"){
    return String(temperaturaDesejada);
  }
  return String();
}
